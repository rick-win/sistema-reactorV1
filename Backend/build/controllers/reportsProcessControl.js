...
class ReportsProcessController {
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const product = yield database_1.default.query('SELECT * FROM Reporte_Proceso WHERE id_reprt_procso = ?', [id]);
            if (product.length > 0) {
...
exports.processController = new ReportsProcessController();
